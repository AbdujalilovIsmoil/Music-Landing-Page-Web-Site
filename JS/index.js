...
let MusicImage = document.querySelector(".section__box_music_play_img");
let musicPlay = document.querySelector(".section__box_music_play_icons .fa-play");
let musicPause = document.querySelector(".section__box_music_play_icons .fa-pause");
let next = document.querySelector(".fa-forward");
let prev = document.querySelector(".fa-backward");
let title = document.querySelector(".section__box_music_play_title");
let audio = document.getElementById("audio");
let navText = document.querySelector(".nav__text");
let progress = document.querySelector(".section__box_music_play_border_box");
let progressContainer = document.querySelector(".section__box_music_play_border");
